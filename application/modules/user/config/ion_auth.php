 ...
 */
$config['site_title'] = "Your code will be activated after clicking link";       // Site Title, example.com
$config['admin_email'] = "samina.tuladhar7@gmail.com"; // Admin Email, admin@example.com
...
$config['email_forgot_password'] = TRUE;
/*
  | -------------------------------------------------------------------------
  | Cookie options.
  | -------------------------------------------------------------------------
