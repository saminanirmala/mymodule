...
//                    
            ...
            $this->_render_page('admin_dashboard', $data);
        }
    }
...
//                      echo json_encode($data['message']);		
    ...
    function send_mail_1($subject, $from, $to, $text, $html) {

        $transport = Swift_SmtpTransport::newInstance('smtp.mandrillapp.com', 587);
        $transport->setUsername('sumanr@ekbana.com');
        $transport->setPassword('k2Dgsq1ARER6W7olPHslGQ');
    ...
    function change_password() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            //render
            $this->_render_page('hr/change_password', $data);
        } else {
    ...
    function forgot_password() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
            $this->_render_page('forgot_password.tpl.php', $data);
        } else {
    ...
    public function reset_password($code = NULL) {
        ...
        if ($user) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                //render
                $this->_render_page('reset_password', $data);
            } else {
...
//		$this->form_validation->set_rules('phone', $this->lang->line('create_user_validation_phone_label'), 'required|xss_clean');
        ...
        if ($this->form_validation->run() == true) {
            ...
            $additional_data = array(
                ...
                'company' => $this->input->post('address'),
...
//             echo$row['group']->group_id ; die();
        if ($row['group']->group_id == 2) {
            $this->load->view('user_dashboard', $row);
        } else if ($row['group']->group_id == 3) {
            $this->load->view('hr_dashboard', $row);
        } else {
            $this->load->view('superadmin_dashboard', $row);
        }
    }
